...
interface ServerDetailPokemonViewProps {
  details: PokemonDetail;
}

export default function ServerDetailPokemonView({
  details,
}: ServerDetailPokemonViewProps) {
  return (
    <div className="flex flex-col gap-6 w-full mb-16 md:mb-0">
      <div className="flex xl:hidden flex-col">
        <div className="flex items-center gap-4 w-fit">
          <Link href="/server-rendering" className="chip-type cursor-pointer">
            <IconChevronLeft />
          </Link>
              ...
              <div key={key} className="flex flex-col gap-2">
                <div className="flex items-center gap-3">
                  ...
                  <p
                    ...
                    style={{
                      color: ColorType(details?.types?.[0]?.type?.name),
                    }}
                  >
                    {pokeStat?.base_stat}
                  </p>
        ...
        <div className="flex items-center relative w-full">
          <div className="flex relative w-full h-[365px] md:h-[685px] xl:h-full items-center justify-center overflow-hidden xl:pr-24">
            <div
              ...
              style={{
                borderColor: `${ColorType(details?.types?.[0]?.type?.name)}1a`,
              }}
            >
              <div
